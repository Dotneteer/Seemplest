...
namespace Seemplest.MsSql.UnitTests.DataAccess
{
    ...
    public class SqlExpressionTest
    {
        ...
        [TestMethod]
        public void TopWorksAsExpected()
        {
            // --- Act
            var expr1 = new SqlExpression("select ").Top(5);
            var expr2 = SqlExpression.New.Select("a", "b").Top(12);
            var expr3 = new SqlExpression("select distinct").Top(5);
            var expr4 = SqlExpression.New.Select("a", "b").Distinct.Top(12);
            var expr5 = new SqlExpression("select all").Top(5);
            var expr6 = SqlExpression.New.Select("a", "b").Distinct.Top(12, true);
            var expr7 = SqlExpression.New.Select("a", "b").Distinct.Top(12, true, true);
            var expr8 = SqlExpression.New.Select("a", "b").Distinct.Top(12, true, true).Top(3);
            var expr9 = SqlExpression.New.Select("a", "b").Distinct.Top(12, true, true).Top(5, false, true);

            // --- Assert
            expr1.SqlText.ShouldEqual("select top(5)");
            expr2.SqlText.ShouldEqual("select top(12) a, b");
            expr3.SqlText.ShouldEqual("select distinct top(5)");
            expr4.SqlText.ShouldEqual("select distinct top(12) a, b");
            expr5.SqlText.ShouldEqual("select all top(5)");
            expr6.SqlText.ShouldEqual("select distinct top(12) percent a, b");
            expr7.SqlText.ShouldEqual("select distinct top(12) percent with ties a, b");
            expr8.SqlText.ShouldEqual("select distinct top(3) a, b");
            expr9.SqlText.ShouldEqual("select distinct top(5) with ties a, b");
        }
